...
namespace NhaHangTiecCuoi.Areas.Admin.Controllers
{
    public class LoaiDichVusController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaLoai,TenLoai")] LoaiDichVu loaiDichVu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaLoai,TenLoai")] LoaiDichVu loaiDichVu)
        {
            if (ModelState.IsValid)
            {
